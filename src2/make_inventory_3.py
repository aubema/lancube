...
df_invent['h'] = h
df_invent.to_csv(f'inventaires/lan3_invent_inter_{filename}', index=False)
...
df.to_csv('Validation/Filter/weird_val_filter.csv')
...
df_invent.to_csv('Validation/Filter/1_df_weird_val_filter.csv')



# Filter small flux
df_invent = df_invent[df_invent['flux'] > 250].reset_index(drop=True)
df_invent.to_csv('Validation/Filter/2_df_small_flux_filter.csv')


# Filter multiple detections of the same light
df_invent = filter_multip_detections(df_invent, df_initial, prec_localisation)
df_coord.to_csv('Validation/Filter/coord_multiple_detec.csv')
df_invent.to_csv('Validation/Filter/3_df_multiple_detection.csv')
...
df_coord.to_csv('Validation/Filter/coord_multiple_detec.csv')
df_invent.to_csv('Validation/Filter/3.1_df_multiple_detection.csv')
...
df_coord.to_csv('Validation/Filter/coord_small_removed.csv')
df_invent.to_csv('Validation/Filter/4_df_filter_small.csv')
